...
public sealed class NetworkPlayerVisualMode : NetworkBehaviour
{
    ...
    {
        // Los dem�s jugadores no deben ver las patas flotantes
        // que pertenecen a la c�mara de primera persona.
        SetActiveSafely(firstPersonRig, false);

        // El modelo completo s� debe verse para jugadores remotos.
        SetActiveSafely(thirdPersonModel, true);
